        ...
        <div className="mx-auto w-full max-w-[420px]">
          <div className="w-full min-h-[540px] p-0 sm:rounded-2xl sm:border sm:border-border sm:bg-card sm:p-6 sm:shadow-2xl">
            <div className="text-center">
              ...
              <p className="mb-0 typo-section-title text-primary dark:text-white">Template Administrativo</p>
              <p className="typo-caption">Base reutilizavel para novos projetos</p>
            </div>
            ...
            <div className="mt-3 p-0 sm:rounded-xl sm:bg-card sm:p-6">
              <form onSubmit={handleSubmit}>
                ...
                <Button
                  type="submit"
                  className="mt-6 h-11 w-full typo-body font-semibold text-white bg-[var(--color-brand-primary)] hover:bg-[var(--color-brand-primary-dark)]"
                  disabled={loading}
                >
